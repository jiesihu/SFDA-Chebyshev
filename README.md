...
## Download datasets
The preprocessed datasets can be found in the repository of the paper [Source-Free Domain Adaptive Fundus Image Segmentation with Denoised Pseudo-Labeling](https://github.com/cchen-cc/SFDA-DPL?tab=readme-ov-file).
