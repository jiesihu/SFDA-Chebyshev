...
class DeepLab(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
                 sync_bn=True, freeze_bn=False, BraTs = False):
        ...
        self.backbone = build_backbone(backbone, output_stride, BatchNorm,BraTs = BraTs)
...
class DeepLab_FSM(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, num_classes=21,
                 sync_bn=True, freeze_bn=False, BraTs = False):
        super(DeepLab_FSM, self).__init__()
        if backbone == 'drn':
            output_stride = 8
